...
from app.services.captcha_solver import solve_captcha_with_fallback
        ...
        while attempts < max_attempts:
            ...
            try:
                ...
                captcha_img = await page.wait_for_selector(
                    "img[src*='simpleCaptcha']", timeout=5000
                )
                if not captcha_img:
                ...
                captcha_text = await solve_captcha_with_fallback(captcha_bytes)
                if not captcha_text:
