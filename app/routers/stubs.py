...
router = APIRouter(tags=["stubs"], dependencies=[Depends(verify_api_key)])
...
async def verify_mesrs_diploma():
    return {
        ...
        "message": "MESRS diploma verification is not yet implemented.",
    }
...
async def verify_ordre_medecins():
    return {
        "status": "not_implemented",
        "message": "Ordre National des Médecins verification is not yet implemented.",
    }
